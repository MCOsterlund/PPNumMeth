...
public partial struct complex{
	...
	//getters. Retrieves a certain value
	public double Re {get{return re;}}
	public double Im {get{return im;}}

	//Constructors. Constructing the complex numbers
	public complex(double x){this.re = x; this.im=0;} //If complex is passed with a signle value, it is interpreted as a real number. I suppose this is done to allow computation between real and complex numbers.
	public complex(double x, double y){this.re=x; this.im=y;}
	//Cast. The defined numbers are cast into operators.
	...
	//Some useful numbers for ease of use.
	public static readonly complex Zero=new complex(0,0);
	public static readonly complex One =new complex(1,0);
	public static readonly complex I =new complex(0,1);

	//Below we define operators
	
	//Complex conjugation
	public static complex operator ~(complex a){
		return new complex(a.Re,-a.Im);}
	public complex conj(){
		return new complex(this.Re,-this.Im);} //Two implementations of the same thing.
	...
	//Complex number magnitued and argument
	...
	//ToString. How our complex numbers should be presented.
